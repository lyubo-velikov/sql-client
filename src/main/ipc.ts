...
import { connectToDatabase, disconnectDatabase, getConnection, getCurrentDatabase } from './db'
import { addEntry, getEntries, searchEntries, clearEntries } from './history'
import { getAllConnections, addConnection, updateConnection, deleteConnection, duplicateConnection } from './connections'
import * as queryFiles from './queryFiles'
import * as ai from './ai'
import type { UndoData, UndoOperation, StatementWithMeta, AiConversation } from '../shared/types'
...
export function registerIpcHandlers(): void {
  ...
  ipcMain.handle('ai:save-conversation', async (_event, params: { conversation: AiConversation }) => {
